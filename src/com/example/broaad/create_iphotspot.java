...
public class create_iphotspot extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.create_iphotspot);
		...
		*/
	       final Dialog d=new Dialog(create_iphotspot.this);
			...
			public void onClick(View v) {
				...
				lv.setOnItemClickListener(new OnItemClickListener() {
					...
					//	Toast.makeText(getApplicationContext(), ""+st.getItem(arg2), Toast.LENGTH_SHORT).show();	// TODO Auto-generated method stub
				     ...
				     //startService(new Intent(create_iphotspot.this,senderservice.class));
				     // Toast.makeText(getApplicationContext(), ""+wifi_name, Toast.LENGTH_SHORT).show();
				      Intent i=new Intent(create_iphotspot.this,files.class);
						startActivity(i);
					}
				});
